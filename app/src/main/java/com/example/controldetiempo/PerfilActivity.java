...
public class PerfilActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtcedulaPerfil=(TextView)findViewById(R.id.textViewCedulaPerfil);
        ...
        txtcedulaPerfil.setText(sharedpreferences.getString(Id,""));
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()) {
                            case R.id.inicio:
                                ...
                                Toast.makeText(PerfilActivity.this, "Pantalla: " + menuItem.getTitle().toString(), Toast.LENGTH_SHORT).show();
                            ...
                            case R.id.logout:
                                ...
                                Intent intent4 = new Intent(PerfilActivity.this,LoginActivity.class);
                                //intent.putExtras(basket);
